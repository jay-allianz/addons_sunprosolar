...
# without forcing the installation of project.
#

class project_meeting_type(osv.Model):
    _name = 'project.meeting.type'
    _description = 'Meeting Type'
    _columns = {
        'name': fields.char('Name', size=64, required=True, translate=True),
    }

class project_meeting(base_state, osv.Model):
    ...
    _columns = {
        ...
        'partner_ids': fields.many2many('res.partner', 'project_meeting_partner_rel', 'meeting_id', 'partner_id',
    ...
    def message_get_subscription_data(self, cr, uid, ids, context=None):
        ...
        for virtual_id in ids:
            ...
            result = super(project_meeting, self).message_get_subscription_data(cr, uid, [real_id], context=context)
    ...
    def copy(self, cr, uid, id, default=None, context=None):
        ...
        return super(project_meeting, self).copy(cr, uid, id, default, context)
