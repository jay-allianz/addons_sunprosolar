...
#                'change_sign' : 1, 
#                'balanceinit' : 0.0, 
#                'ytd' :  abs(form_copy.get('periodic_net_profit_one')), 
#            }
#            
#            if form['compr0_fiscalyear_id']:
#                self.total_profit_loss.update({
...
#            result_acc.append(self.total_profit_loss)
#            
#            total_liabilities_equity = self.tot_liabilities_equity + abs(form_copy.get('periodic_net_profit_one'))
...
#                'change_sign' : 1, 
#                'balanceinit' : 0.0, 
#                'ytd' : self.tot_liabilities + abs(form_copy.get('periodic_net_profit_one')) 
#            }
#            
#            if form['compr0_fiscalyear_id']:
#                self.total_liabilities_equity.update({
