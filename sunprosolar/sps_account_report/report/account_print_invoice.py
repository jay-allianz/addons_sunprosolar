...
class sps_account_invoice(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(sps_account_invoice, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw(
    ...
    'account.invoice',
    'addons/sps_account_report/report/account_print_invoice.mako',
    parser=sps_account_invoice
)
